...
function getCommands(): Command[] {
  return [
    ...
    { id: 'tab-file', label: '切换到文件管理', shortcut: 'Ctrl+3', category: '导航', execute: () => useUIStore.getState().setActiveTab('file') },
    { id: 'tab-monitor', label: '切换到监控', shortcut: 'Ctrl+4', category: '导航', execute: () => useUIStore.getState().setActiveTab('monitor') },
    { id: 'tab-network', label: '切换到网络', shortcut: 'Ctrl+5', category: '导航', execute: () => useUIStore.getState().setActiveTab('network') },
    { id: 'tab-docker', label: '切换到Docker', shortcut: 'Ctrl+6', category: '导航', execute: () => useUIStore.getState().setActiveTab('docker') },
    { id: 'tab-tools', label: '切换到网络工具', shortcut: 'Ctrl+7', category: '导航', execute: () => useUIStore.getState().setActiveTab('tools') },
