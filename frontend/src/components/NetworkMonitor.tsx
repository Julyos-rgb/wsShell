  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-3">
        <div className="h-44 bg-surface-500/50 rounded-lg p-3 border border-border/30">
          <Line data={chartData} options={chartOptions} />
        </div>

        <div className="grid grid-cols-2 gap-2">
          <div className="bg-surface-500/50 rounded-lg px-3 py-2 border border-border/30">
        ...
        <div className="bg-surface-500/50 rounded-lg border border-border/30 overflow-hidden">
                ...
                {connList.length === 0 ? (
                  ...
                  connList.map((c, i) => (
                    <tr
                      ...
                      className="border-b border-border/10 hover:bg-surface-50/20 transition-colors"
                    >
                      ...
                      <td className="px-3 py-1.5">
                        <span className={`inline-block px-1.5 py-0.5 rounded text-[10px] font-medium ${stateColor(c.state)}`}>
                          {c.state}
                        </span>
                      </td>
